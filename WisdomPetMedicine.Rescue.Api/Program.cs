...
app.UseCloudEvents(); //the pubsub building block is based on the CloudEvents specification.
app.MapSubscribeHandler(); //map the handler capable of receiving messages from the pubsub dapr building block.
app.MapControllers();
