...
{
    private readonly IServiceScopeFactory serviceScopeFactory; //obtain dbcontext from EF
    private readonly IPatientAggregateStore patientAggregateStore;
    private readonly ILogger<IntegrationEventsController> logger;

    public IntegrationEventsController(IServiceScopeFactory serviceScopeFactory, IPatientAggregateStore patientAggregateStore, 
